...
public class CallenderActivity extends AppCompatActivity {
...
//        Typeface typeface = Typeface.createFromAsset(getAssets(), "LobsterTwo-Regular.ttf");
        ...
        calendar.setCalendarListener(new DateRangeCalendarView.CalendarListener() {
            ...
            public void onFirstDateSelected(Calendar startDate) {
                Toast.makeText(CallenderActivity.this, "Start Date: " + startDate.getTime().toString(), Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onDateRangeSelected(Calendar startDate, Calendar endDate) {
                Toast.makeText(CallenderActivity.this, "Start Date: " + startDate.getTime().toString() + " End date: " + endDate.getTime().toString(), Toast.LENGTH_SHORT).show();
            }
